...
public class BillPlusMain {
	...
	public static void main(String[] args) {
		...
		contracts.addUserContract(123L, new Contract("John Doe", null, month5, PricingPlan.BASIC));
		//contracts.addUserContract(456L, new Contract("Paul Smith", null, month5, PricingPlan.LEVEL2));
		
		final EnumSet<Option> options = EnumSet.of(MULTICALLS, REPORTING, CREDITCARD);
		//contracts.addUserContract(789L, new Contract("Rihanna", null, month5, PricingPlan.LEVEL1, options));
		//contracts.addUserContract(1123L, new Contract("Britney", null, month5, PricingPlan.FLEXI_L));
